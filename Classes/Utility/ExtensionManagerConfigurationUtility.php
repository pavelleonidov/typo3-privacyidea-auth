<?php
namespace PavelLeonidov\PrivacyideaAuth\Utility;
 ...
 *      2018 Pavel Leonidov <info@pavel-leonidov.de>
 *
 *  All rights reserved
 *
...
class ExtensionManagerConfigurationUtility {
	...
	private function init() {
		...
		$this->getLanguageService()->includeLLFile('EXT:privacyidea_auth/Resources/Private/Language/locallang.xlf');
	}
